...
class PlayerControls {
    ...
    showLoading(status = 'Loading...', details = '') {
        // Loading screen removed - just log to console for debugging
        console.log('Loading:', status, details);
    }
     ...
     */
    showPlayer() {
        // Player is now always active - this method kept for compatibility
